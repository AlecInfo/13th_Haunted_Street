...
{ 
    class MainMenuOld
    {
        ...
        // Ctor
        public MainMenuOld(Texture2D background, SpriteFont font)
        {
        ...
        // singleton
        public static MainMenuOld Instence(Texture2D background, SpriteFont font)
        {
            if (_instance == null)
            {
                _instance = new MainMenuOld(background, font);
            }
            return _instance;
        }
